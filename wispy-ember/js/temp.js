...
//            if ((this.opacity >= this.opacityLimit) && (!this.opacityReversing) && (this.durationCounter === this.durationTotal)) {
//                this.opacityReversing = true;
//                this.opacityIncrement *= -1;
//            }
//            if ((this.opacity < this.opacityLimit) && (!this.opacityReversing)) {
//                this.opacity += this.opacityIncrement;
//            }
//            if (this.opacityReversing) {
//                this.opacity += this.opacityIncrement;
//            }
